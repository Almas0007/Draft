...
class NotifyWork(context: Context, params: WorkerParameters) : Worker(context, params) {
    ...
    private fun sendNotification(id: Int) {
        ...
        val titleNotification = applicationContext.getString(R.string.notify_title)
        val subtitleNotification = applicationContext.getString(R.string.notify_description)
